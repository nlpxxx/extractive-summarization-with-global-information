...
class Batch(object):
    ...
    def __init__(self, data=None, device=None,  is_test=False):
        ...
        if data is not None:
            ...
            # pre_segs = [x[2] for x in data] # batch_size * segs_len
...
class Dataloader(object):
    ...
    def _next_dataset_iterator(self, dataset_iter):
        try:
            ...
            self.cur_dataset = next(dataset_iter)   # 一整个文件里的文章
...
class DataIterator(object):
    ...
    def preprocess(self, ex, is_test):
        ...
        if(is_test):
            return src, labels, clss, tgt, src_txt, tgt_txt
        else:
            return src, labels, clss, tgt

...
def wait_and_validate(args, device_id):
    ...
    if (args.test_all):
        ...
        for i, cp in enumerate(cp_files):
            ...
            # if (i - max_step > 20):
            #     break
        xent_lst = sorted(xent_lst, key=lambda x: x[0])[:1]
...
if __name__ == '__main__':
    ...
    parser.add_argument("-bert_data_path", default='/cnndm')
    parser.add_argument("-model_path", default='./models/')
    parser.add_argument("-result_path", default='./results/cnndm')
    parser.add_argument("-temp_dir", default='./temp')
    parser.add_argument("-bert_config_path", default='')
    ...
    parser.add_argument("-save_from", default=0, type=int)
    ...
    parser.add_argument("-ntopic", default=128, type=int)
    parser.add_argument("-num_negative", default=10, type=int)
